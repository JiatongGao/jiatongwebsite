function loadContent(section) {
    ...
    if (section === "about") {
                ...
                <div class="footer-content">
                    ...
                    <div class="contact-methods">
                        <div class="contact-item">
                            ...
                            <a href="mailto:travisgao58@gmail.com">travisgao58@gmail.com</a>
                        </div>
                        <div class="contact-item">
                            <i class="fas fa-phone"></i>
                            <span>+1 (206)-886-8895</span>
                        </div>
                    </div>
                </div>
            </footer>
        ...
        if (section === "experience") {
            ...
            content.innerHTML = `
                <h2>Interest</h2>
                <p>I am interested in [your interests], and I enjoy [another activity or hobby]...</p>
            `;
        }
    }
}
